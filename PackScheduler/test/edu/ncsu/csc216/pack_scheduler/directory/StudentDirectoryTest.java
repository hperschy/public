...
public class StudentDirectoryTest {
	...
	public void testLoadStudentsFromFile() {
		...
		//Test invalid file
		try{
			sd.loadStudentsFromFile("#notAllFiles");
			fail();
	...
	public void testAddStudent() {
		...
		sd.addStudent("firstName", "lastName", "001", "email@email.com", "password", "password", 15);
		studentDirectory = sd.getStudentDirectory();
		assertEquals(2, studentDirectory.length);
		assertEquals("firstName", studentDirectory[1][0]);
		assertEquals("lastName", studentDirectory[1][1]);
		assertEquals("001", studentDirectory[1][2]);
