...
public class CourseTest {
	...
	public void testCompareTo() {
		Course c1 = new Course("CSC101", "DNEmaybe", "001", 4, "pbrooks", "MTWHF", 1100, 1110);
		Course c11 = new Course("CSC101", "DNEmaybe", "001", 4, "pbrooks", "MTWHF", 1100, 1110);
		Course c2 = new Course("CSC102", "DNEiguess", "001", 4, "pbrooks", "MTWHF", 1100, 1110);
		Course c3 = new Course("CSC100", "DNEmaybe", "001", 4, "pbrooks", "MTWHF", 1100, 1110);
		Course c101 = new Course("CSC101", "DNEmaybe", "002", 4, "pbrooks", "MTWHF", 1100, 1110);
		
		assertTrue(c1.compareTo(c11) == 0);
		assertTrue(c2.compareTo(c1) > 0);
		assertTrue(c1.compareTo(c2) < 0);
		assertTrue(c3.compareTo(c1) < 0);
		assertTrue(c1.compareTo(c3) > 0);
		assertTrue(c101.compareTo(c1) > 0);
	}
	...
	public void testGetShortDisplayArray() {
		Course c = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, MEETING_DAYS, START_TIME, END_TIME);
		String[] shortDisplay = c.getShortDisplayArray();
		assertEquals(shortDisplay[0], NAME);
		assertEquals(shortDisplay[1], SECTION);
		assertEquals(shortDisplay[2], TITLE);
		assertEquals(shortDisplay[3], c.getMeetingString());
	}
	...
	public void testGetLongDisplayArray() {
		...
		assertEquals(longDisplay[0], NAME);
		assertEquals(longDisplay[1], SECTION);
		assertEquals(longDisplay[2], TITLE);
		assertEquals(longDisplay[3], "" + CREDITS);
		assertEquals(longDisplay[4], INSTRUCTOR_ID);
		assertEquals(longDisplay[5], c.getMeetingString());
		assertEquals(longDisplay[6], "");
	}
}